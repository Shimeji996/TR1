...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Vector3 cameraPosition = { 410,360,-1000 };

	Vector3 kLocalVertices[4]{};

	kLocalVertices[0] = { 0, 0, 0 };//左下
	kLocalVertices[1] = { 1280, 0, 0 };//右下
	kLocalVertices[2] = { 0, -720, 0 };//左上
	kLocalVertices[3] = { 1280, -720, 0 };//右上
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Novice::ScreenPrintf(0, 0, "%d", RotateTimer);
